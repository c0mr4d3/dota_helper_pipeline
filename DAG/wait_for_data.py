...
queryschema = open(f'{dags_folder}/util/match_heroes.json', 'r').read()
dag_id = "match_data_operations"

globals()[dag_id] = create_dag(dag_id, queryschema, default_args)